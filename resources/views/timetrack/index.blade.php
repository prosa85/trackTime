        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($timetrack as $item)
                ...
                <tr>
                    ...
                    <td>{{ $item->start }}</td><td>{{ $item->end }}</td><td> {{$item->hours}} </td><td> <a target="_BLANK" href="https://bitbucket.org/gordos_programming/dsl-laravel/commits/{{$item->commit}}">{{$item->commit}}</a> </td>
                    <td>
